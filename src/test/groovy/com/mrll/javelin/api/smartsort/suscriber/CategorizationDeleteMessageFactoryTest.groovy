...
class CategorizationDeleteMessageFactoryTest extends Specification {

    @Subject
    CategorizationDeleteMessageFactory categorizationDeleteMessageFactory = new CategorizationDeleteMessageFactory()
    ...
    def 'Successful message creation'() {
        ...
        when:
        metadataUpdateEventMsg = categorizationDeleteMessageFactory.createMessage(message)
    ...
    def 'Failed to create message'() {
        ...
        when:
        categorizationDeleteMessageFactory.createMessage(message)
