...
class EventProxyFilterMessageValidatorTest extends Specification {

    @Subject
    EventProxyFilterMessageValidator eventMessageValidator = new EventProxyFilterMessageValidator()
